...
public class ResultPanelGenerator : IUIPanelsInstantiate
{
    ...
    private LoadingScreenFactory _loadingScreen;
    private ScoreCounter _scoreCounter;
    public ResultPanelGenerator(Transform spawnTransform, LoadingScreenFactory loadingScreen, ScoreCounter scoreCounter)
    {
